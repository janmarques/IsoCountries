...
namespace ExtendedIsoCountries
{
    ...
    {
        private Country(string name, string alpha2Code, string alpha3Code, int numericCode, string adjective, string demonym)
        {
            Name = name;
        ...
        public static List<Country> Countries = new List<Country>()
        {
            ...
            new Country("Bolivia (Plurinational State of)", "BO", "BOL",68, "Bolivian", "Bolivian"),
            ...
            new Country("British Indian Ocean Territory (the)", "IO", "IOT",86, "BIOT", "British"),
            ...
            new Country("Cayman Islands (the)", "KY", "CYM",136, "Caymanian", "Caymanian"),
            new Country("Central African Republic (the)", "CF", "CAF",140, "Central African", "Central African"),
            ...
            new Country("Cocos (Keeling) Islands (the)", "CC", "CCK",166, "Cocossian", "Cocossian"),
            new Country("Colombia", "CO", "COL",170, "Colombian", "Colombian"),
            new Country("Comoros (the)", "KM", "COM",174, "Comoran", "Comoran"),
            new Country("Congo (the Democratic Republic of the)", "CD", "COD",180, "Congolese", "Congolese"),
            new Country("Congo (the)", "CG", "COG",178, "Congolese", "Congolese"),
            ...
            new Country("Dominican Republic (the)", "DO", "DOM",214, "Dominican", "Dominican"),
            ...
            new Country("Falkland Islands (the) [Malvinas]", "FK", "FLK",238, "Falkland Island", "Falkland Islander"),
            new Country("Faroe Islands (the)", "FO", "FRO",234, "Faroese", "Faroese"),
            ...
            new Country("French Southern Territories (the)", "TF", "ATF",260, "French Southern Territories", null),
            new Country("Gabon", "GA", "GAB",266, "Gabonese", "Gabonese"),
            new Country("Gambia (the)", "GM", "GMB",270, "Gambian", "Gambian"),
            ...
            new Country("Holy See (the)", "VA", "VAT",336, "Vatican", "Vatican"),
            ...
            new Country("Iran (Islamic Republic of)", "IR", "IRN",364, "Iranian", "Iranian"),
            ...
            new Country("Korea (the Democratic People's Republic of)", "KP", "PRK",408, "North Korean", "North Korean"),
            new Country("Korea (the Republic of)", "KR", "KOR",410, "South Korean", "South Korean"),
            new Country("Kuwait", "KW", "KWT",414, "Kuwaiti", "Kuwaiti"),
            new Country("Kyrgyzstan", "KG", "KGZ",417, "Kyrgyzstani", "Kyrgyzstani"),
            new Country("Lao People's Democratic Republic (the)", "LA", "LAO",418, "Laotian", "Laotian"),
            ...
            new Country("Marshall Islands (the)", "MH", "MHL",584, "Marshallese", "Marshallese"),
            ...
            new Country("Micronesia (Federated States of)", "FM", "FSM",583, "Micronesian", "Micronesian"),
            new Country("Moldova (the Republic of)", "MD", "MDA",498, "Moldovan", "Moldovan"),
            ...
            new Country("Northern Mariana Islands (the)", "MP", "MNP",580, "Northern Mariana Island", "Northern Mariana Islander"),
            ...
            new Country("Philippines (the)", "PH", "PHL",608, "Filipino", "Filipino"),
            ...
            new Country("Russian Federation (the)", "RU", "RUS",643, "Russian", "Russian"),
            ...
            new Country("Saint Martin (French part)", "MF", "MAF",663, "Saint-Martinoise", "Saint-Martinoise"),
            ...
            new Country("Sint Maarten (Dutch part)", "SX", "SXM",534, "Sint Maarten", "Sint Maarten"),
            ...
            new Country("Taiwan (Province of China)", "TW", "TWN",158, "Taiwanese", "Taiwanese"),
            ...
            new Country("Turks and Caicos Islands (the)", "TC", "TCA",796, "Turks and Caicos Island", "Turks and Caicos Islander"),
            ...
            new Country("United Arab Emirates (the)", "AE", "ARE",784, "Emirian", "Emirian"),
            new Country("United Kingdom of Great Britain and Northern Ireland (the)", "GB", "GBR",826, "British", "British"),
            new Country("United States Minor Outlying Islands (the)", "UM", "UMI",581, null, null),
            new Country("United States of America (the)", "US", "USA",840, "American", "American"),
            ...
            new Country("Venezuela (Bolivarian Republic of)", "VE", "VEN",862, "Venezuelan", "Venezuelan"),
            new Country("Viet Nam", "VN", "VNM",704, "Vietnamese", "Vietnamese"),
            new Country("Virgin Islands (British)", "VG", "VGB",92, "Virgin Island", "Virgin Islander"),
            new Country("Virgin Islands (U.S.)", "VI", "VIR",850, "Virgin Island", "Virgin Islander"),
