    ...
    public sealed class Country
    {
        static Country()
        {
            Countries = new List<Country>()
            {
                ...
                new Country("Bahamas", "BS", "BHS",44, "Bahameese", "Bahameese"),
                ...
                new Country("Cook Islands", "CK", "COK",184, "Cook Islander", "Cook Islander"),
                ...
                new Country("Macedonia", "MK", "MKD",807, "Macedonian", "Macedonian"),
